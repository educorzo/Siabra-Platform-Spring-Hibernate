...
<body role="document">
	<div class="container theme-showcase" role="main">
		<div class="jumbotron">
			...
			<form style="display: inline;" name='paginasWebForm'
				...
				<div id="div_facebook" class="form-group">
					...
					<input
						...
						>
					<span
						class="help-block" id="help_facebook">Ex.www.facebook.com/NameSurname </span>
				</div>
				<div class="form-group" id="div_twitter">
					<label class="control-label" for="id_twitter">Twitter</label>
					<input
						class="form-control" id="id_twitter" maxlength="90"
						name="twitter" placeholder="Twitter"
						title="Ex.www.twitter.com/NameSurname" type="text"
						value='<c:out value="${model.twitter}"></c:out>'
							onchange="validarUrl(value,'div_twitter','help_twitter')"
						>
					<span
						class="help-block" id="help_twitter">Ex.www.twitter.com/NameSurname </span>
				</div>
				<div class="form-group" id="div_linkedin">
					<label class="control-label" for="id_linkedin">LinkedIn</label>
					<input
						...
						>
					<span
						class="help-block" id="help_linkedin">Ex.www.linkedin.com/NameSurname </span>
				</div>
				<div class="form-group" id="div_webPersonal">
					<label class="control-label" for="id_webPersonal">Personal web</label>
					<input
						class="form-control" id="id_webPersonal" maxlength="90"
						...
						>
					<span
						class="help-block" id="help_webPersonal">Ex.www.wordpress.com/pepe</span>
				</div>
				<div class="form-group" id="div_webProfesional">
					<label class="control-label" for="id_webProfesional">Profesional web</label>
					<input
						class="form-control" id="id_webProfesional" maxlength="90"
						name="webProfesional" placeholder="Profesional web"
						...
						>
					<span
						class="help-block" id="help_webProfesional">Ex.www.biosearch.com</span>
				</div>
